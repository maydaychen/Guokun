...
public class MyAffair_2 extends RelativeLayout {
    ...
    public MyAffair_2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        init();
    }

    public MyAffair_2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyAffair_2(Context context) {
        this(context, null);
    }

    private void init() {
        baseV = LayoutInflater.from(mContext).inflate(R.layout.affair_2, this);
