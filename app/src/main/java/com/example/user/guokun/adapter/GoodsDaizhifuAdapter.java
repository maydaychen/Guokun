...
import com.example.user.guokun.ui.activity.PayActivity;
...
public class GoodsDaizhifuAdapter extends RecyclerView.Adapter<GoodsDaizhifuAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public GoodsDaizhifuAdapter(Context context) {
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_order_daifukuan, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mBtDaifukuanPaynow.setOnClickListener(view -> {
            Intent intent = new Intent(mContext, PayActivity.class);
            intent.putExtra("price",mData.get(position).getGoods().get(0).getPrice());
            intent.putExtra("order_num",mData.get(position).getOrdersn());
            mContext.startActivity(intent);

        });
        holder.mBtCancelOrder.setOnClickListener(view -> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.bt_daifukuan_paynow)
        Button mBtDaifukuanPaynow;
