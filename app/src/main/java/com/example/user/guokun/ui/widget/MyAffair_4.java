...
public class MyAffair_4 extends RelativeLayout {
    ...
    public MyAffair_4(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        init();
    }

    public MyAffair_4(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyAffair_4(Context context) {
        this(context, null);
    }

    private void init() {
        baseV = LayoutInflater.from(mContext).inflate(R.layout.affair_4, this);
