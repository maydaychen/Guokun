...
import com.example.user.guokun.adapter.ShouhouAdapter;
...
public class ShouhouFragment extends Fragment implements PullLoadMoreRecyclerView.PullLoadMoreListener {
    ...
    private ShouhouAdapter mRecyclerViewAdapter;
    private int page = 1;
    ...
    public static ShouhouFragment newInstance(String content) {
        Bundle arguments = new Bundle();
        arguments.putString(EXTRA_CONTENT, content);

        ShouhouFragment mallFragment = new ShouhouFragment();
    ...
    public void initData() {
        ...
        mRecyclerViewAdapter = new ShouhouAdapter(getActivity());
    ...
    private void getData1() {
        HttpShopMethod.getInstance().orders(new ProgressErrorSubscriber<>(VspaOnNext,
                getActivity()), mPreferences.getString("access_token", ""), mPreferences.getString("sessionkey", ""), page, "r1");
    }
}
