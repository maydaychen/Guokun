...
import com.example.user.guokun.adapter.GoodsDaifahuoAdapter;
...
public class DaifahuoFragment extends Fragment implements PullLoadMoreRecyclerView.PullLoadMoreListener {
    ...
    private GoodsDaifahuoAdapter mRecyclerViewAdapter;
    private int page = 1;
    ...
    public static DaifahuoFragment newInstance(String content) {
        Bundle arguments = new Bundle();
        arguments.putString(EXTRA_CONTENT, content);

        DaifahuoFragment mallFragment = new DaifahuoFragment();
    ...
    public void initData() {
        ...
        mRecyclerViewAdapter = new GoodsDaifahuoAdapter(getActivity());
    ...
    private void getData1() {
        HttpShopMethod.getInstance().orders(new ProgressErrorSubscriber<>(VspaOnNext,
                getActivity()), mPreferences.getString("access_token", ""), mPreferences.getString("sessionkey", ""), page, "1");
    }
}
