...
public class MyAffair_3 extends RelativeLayout {
    ...
    public MyAffair_3(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        init();
    }

    public MyAffair_3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyAffair_3(Context context) {
        this(context, null);
    }

    private void init() {
        baseV = LayoutInflater.from(mContext).inflate(R.layout.affair_3, this);
